...
function populate() {
  ...
  for (var i = 0; i < topics.length; i++) {
    $('#buttonArea').append("<button class='btn btn-default topics' data-topic='" + topics[i] + "'>" + topics[i] + "</button>");
  }
}
...
$('#submit')
  .on('click', function (event) {
    ...
    $('#buttonArea').append("<button class='btn btn-default topics' data-topic='" + newTopic + "'>" + newTopic + "</button>");
